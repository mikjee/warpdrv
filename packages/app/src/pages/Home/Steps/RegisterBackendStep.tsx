	...
	>
		<VStack align="stretch" gap="3">
			<Text fontSize="13px" color="var(--w-home-steps-text)" lineHeight="1.6">
				1. Visit{' '}
				<ChakraLink href="https://github.com/ggml-org/llama.cpp/releases" isExternal color="var(--w-home-steps-link)" _hover={{ color: 'var(--w-home-steps-link-hover)' }} onClick={(e) => { e.preventDefault(); openExternal('https://github.com/ggml-org/llama.cpp/releases'); }}>
					LlaMA.cpp releases
				</ChakraLink>{' '}
				and download a prebuilt binary for your hardware.
				<br />
				Note: You can also <span style={{
					background: "var(--w-home-steps-register-code-bg)",
					fontFamily: "mono",
				}}>&nbsp;git clone https://github.com/ggml-org/llama.cpp.git&nbsp;</span> into a folder and build from source. See{' '}
				<ChakraLink href="https://github.com/mikjee/warpdrv/blob/master/docs/guides/recipes.md" isExternal color="var(--w-home-steps-link)" _hover={{ color: 'var(--w-home-steps-link-hover)' }} onClick={(e) => { e.preventDefault(); openExternal('https://github.com/mikjee/warpdrv/blob/master/docs/guides/recipes.md'); }}>
					Recipes Guide
				</ChakraLink>.
				<br />
				<br />
				2. Open the{' '}
				<ChakraLink as={NavLink} to="/backends" style={{ textDecoration: 'none' }} color="var(--w-home-steps-link)" _hover={{ color: 'var(--w-home-steps-link-hover)' }}>
					Backends page
				</ChakraLink>{' '}
