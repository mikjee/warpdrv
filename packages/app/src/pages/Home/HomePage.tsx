		...
		>
			...
			<Box pt="76px" px="4" pb="4">
				<VStack align="stretch" gap="5">
					...
					<Flex align="center" justify="space-between">
						<HStack gap="3">
							...
							<VStack align="flex-start" gap="0">
								<Text fontSize="20px" fontWeight="500" color="var(--w-home-greeting-welcome)">
									Welcome
								</Text>
								<Text fontSize="24px" fontWeight="600" color="var(--w-home-greeting-status)">
						...
						{allComplete && (
							<Flex
								...
								color="var(--w-home-details-btn)"
								_hover={{ bg: 'var(--w-home-details-btn-hover-bg)', color: 'var(--w-home-details-btn-hover-color)' }}
					...
					{(!allComplete || showSteps) && <Box w="100%" h="1px" bg="var(--w-home-separator-steps)" />}
					...
					<Box w="100%" h="1px" bg="var(--w-home-separator-tiles)" />
